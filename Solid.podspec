...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
New way to make queries in Swift.
                   DESC

  s.homepage     = "https://github.com/igormatyushkin014/Solid"
  s.screenshots  = "https://github.com/igormatyushkin014/Solid/raw/master/Logo/logo-1024-300.png"
  ...
  s.source       = { :git => "https://github.com/igormatyushkin014/Solid.git", :tag => s.version }
